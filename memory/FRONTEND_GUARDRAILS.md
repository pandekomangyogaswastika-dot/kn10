...
`/app/frontend/src`, bukan standar aspiratif (KN_02 Zustand/TanStack/ECharts TIDAK dipakai).
...
- **Komponen shadcn** dari `@/components/ui` (atau `components/ui`). **Hindari `<select>` native** (WARN W2) →
