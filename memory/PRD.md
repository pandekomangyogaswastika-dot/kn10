...
**Last Updated:** 15 Jun 2026 (Session #020 — Sub-fase 1.5 Inter-Company Transfer Flow DONE)  
...
- **KN_02:** Tech Stack Standards (coding patterns)
- **KN_03:** Security Standards (auth, audit, permissions)
- **KN_04:** Database Standards (SSOT, UUID, indexes)
- **KN_05:** Real-time Standards (WebSocket, SSE, Redis)
- **KN_06:** RFID Integration (MQTT, edge agent)
- **KN_07:** API Standards (REST design)
- **KN_08:** UI/UX Standards (design system)
- **KN_09:** Performance Standards (optimization rules)
- **KN_10:** Testing Standards (pytest, playwright)
- **KN_11:** Quality Lenses (audit framework)
