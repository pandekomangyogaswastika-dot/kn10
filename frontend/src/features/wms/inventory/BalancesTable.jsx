            ...
            {rows.map((b) => {
              ...
              return (
                <tr key={b.id}
                  ...
                  <td className="px-3 py-2 text-right font-bold tabular-nums">{formatQty(b.on_hand_qty)}</td>
                  ...
                  <td className="px-3 py-2 text-right text-[#34C759] font-bold tabular-nums">{formatQty(b.available_qty)}</td>
