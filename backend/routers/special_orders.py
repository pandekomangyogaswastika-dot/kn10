...
from schemas import PurchaseRequisitionCreate, PurchaseRequisitionItem, SpecialOrderToPR
...
async def create_special_order(payload: SpecialOrderCreate, request: Request) -> Dict[str, Any]:
    ...
    special_order = {
        ...
        # Entity
        "entity_id": payload.entity_id or customer.get("entity_id", "entity_jakarta"),
