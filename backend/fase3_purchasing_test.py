...
class Fase3PurchasingTester:
    def __init__(self, base_url="https://context-builder-13.preview.emergentagent.com"):
...
def main():
    tester = Fase3PurchasingTester("https://context-builder-13.preview.emergentagent.com")
