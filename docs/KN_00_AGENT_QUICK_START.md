...
├── KN_02_TECHSTACK_STANDARDS.md   ← Coding patterns
├── KN_03_SECURITY_STANDARDS.md    ← Security rules
├── KN_04_DATABASE_STANDARDS.md    ← DB standards
├── KN_05_REALTIME_STANDARDS.md    ← WebSocket/SSE/Redis
├── KN_06_RFID_INTEGRATION.md      ← RFID architecture
├── KN_07_API_STANDARDS.md         ← REST design
├── KN_08_UI_UX_STANDARDS.md       ← Design system
├── KN_09_PERFORMANCE_STANDARDS.md ← Performance rules
├── KN_10_TESTING_STANDARDS.md     ← Testing guide
├── KN_11_QUALITY_LENSES.md        ← Audit framework
